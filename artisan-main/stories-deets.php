...
<section>
    ...
    <div class="parent">
        ...
        <div class="div2">
            <img src="artisan_image/<?php echo htmlspecialchars($story['artisanPhoto']); ?>" alt="Artisan Photo">
                ...
                <div class="container">
                    ...
                    <div class="card">
                        <div class="img-container">
                            <img src="uploaded_img/<?php echo $product['productImage']; ?>" alt="<?php echo $product['nameOfProduct']; ?>">
                        </div>
